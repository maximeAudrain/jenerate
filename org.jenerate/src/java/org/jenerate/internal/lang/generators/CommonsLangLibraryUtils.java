...
/**
 * Helper class to ease the construction of the commons-lang library objects to
 * be used by the generator classes. This class cannot be instantiated since it
 * only holds static constants and static helper methods.
 * 
 * @author maudrain
 */
public final class CommonsLangLibraryUtils {
	...
	private static final String COMPARE_TO_BUILDER_POSTFIX = BUILDER_STRING
			+ "CompareToBuilder";
	private static final String HASH_CODE_BUILDER_POSTFIX = BUILDER_STRING
			+ "HashCodeBuilder";
	private static final String EQUALS_BUILDER_POSTFIX = BUILDER_STRING
			+ "EqualsBuilder";
	private static final String TO_STRING_BUILDER_POSTFIX = BUILDER_STRING
			+ "ToStringBuilder";
	private static final String TO_STRING_STYLE_POSTFIX = BUILDER_STRING
			+ "ToStringStyle";
	...
	/**
	 * @return an array containing all the fully constructed styles of the
	 *         ToStringStyle library
	 */
