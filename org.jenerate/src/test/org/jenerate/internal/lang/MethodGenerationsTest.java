...
public class MethodGenerationsTest {
    ...
    public void testGenerateEqualsDefault() throws JavaModelException {
        String equalsMethod = MethodGenerations.createEqualsMethod(objectClass, checkedFields, appendSuper,
                generateComment, compareReferences, addOverride, useGettersInsteadOfFields, useBlocksInIfStatements);
    ...
    public void testGenerateHashCodeDefault() throws JavaModelException {
        String hashcodeMethod = MethodGenerations.createHashCodeMethod(checkedFields, appendSuper, generateComment,
                imNumbers, "", addOverride, useGettersInsteadOfFields);
    ...
    public void testGenerateHashCodeWithCachingField() throws JavaModelException {
        String hashcodeMethod = MethodGenerations.createHashCodeMethod(checkedFields, appendSuper, generateComment,
                imNumbers, HASH_CODE_CACHING_FIELD, addOverride, useGettersInsteadOfFields);
